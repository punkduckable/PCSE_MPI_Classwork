...
int main(int argc, char** argv) {	
	...
	if(rank == 0) {
		...
		// Tag test:
		// Send with tag 1. If recv tag is anything else, caused deadlocking 
		//printf("I am %d. Sending %d with a tag of 1\n",rank,rank);
		...
		// Tag test:
		// Receive with tag 2. Will cause deadlocking if enabled	
